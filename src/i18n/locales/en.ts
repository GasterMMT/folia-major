...
export default {
  ...
  "options": {
    ...
    "stageTrackPillOnHomeDesc": "Off means the lyrics page only. On, it counts at any time: a launch that lands on home, a track change on home, or a walk back from the lyrics page.",
