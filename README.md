...
如果你想直接获得开箱即用的体验，无需手动搭建任何 Node 环境即可使用自带前后端的跨平台桌面版，**请直接前往 [Releases 页面](https://github.com/chthollyphile/folia-major/releases) 下载** 最新版本。

Linux 目前不再提供 AppImage。推荐的获取方式如下：

1. Arch Linux / Manjaro 等 Arch 系发行版：通过 AUR 安装 `folia-major-bin`
2. Debian / Ubuntu / Linux Mint 等：从 Releases 下载 `.deb` 安装包
3. Fedora / RHEL / openSUSE 等：从 Releases 下载 `.rpm` 安装包
4. 其他 Linux 发行版：从 Releases 下载 `tar.gz`，解压后直接运行 `folia-major`
